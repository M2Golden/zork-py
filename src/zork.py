...
def front_of_house(user_input_string, itemList):
    room_num = 4
    isdead = False
    user_input_string = user_input_string.lower()
    if user_input_string == ("take mailbox"):
            print("---------------------------------------------------------")
            print("It is securely anchored.")
    elif user_input_string == ("open mailbox"):
            print("---------------------------------------------------------")
            print("Opening the small mailbox reveals a leaflet.")
    elif user_input_string == ("go north"):
            room_num = 1
    elif user_input_string == ("open door"):
            print("---------------------------------------------------------")
            print("The door cannot be opened.")
    elif user_input_string == ("take boards"):
            print("---------------------------------------------------------")
            print("The boards are securely fastened.")
    elif user_input_string == ("look at house"):
            print("---------------------------------------------------------")
    ...
    elif user_input_string == ("go southwest"):
            room_num = 8
    elif user_input_string == ("read leaflet"):
            print("---------------------------------------------------------")
            print("Welcome to the Unofficial Python Version of Zork. Your mission is to find a Jade Statue.")
    elif user_input_string == ("kick the bucket"):
            print("---------------------------------------------------------")
            print("You die.")
            print("---------------------------------------------------------")
            isdead = True #telling the compu they died
    else:
            print("---------------------------------------------------------")
    return [room_num, isdead]
